        ...
        <div className="flex items-center gap-2">
          ...
          <nav className="ml-auto flex gap-2">
            <a
              ...
              href={safePage > 1 ? `/kantoor/onderzoek?page=${safePage - 1}` : "#"}
            >
              ← Vorige
            </a>
            <a
              ...
              href={safePage < totalPages ? `/kantoor/onderzoek?page=${safePage + 1}` : "#"}
            >
              Volgende →
            </a>
          </nav>
